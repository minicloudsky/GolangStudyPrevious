...
//	//}
//	//fmt.Println(sum)
//	// break 跳出循环，continue 继续执行下一次循环
//	//names := "wangwu"
//	//switch names {
//	//case "zhangsan", "wangwu":
//	//	fmt.Println("you are zhangsan")
//	//	fallthrough
//	//case "lisi":
//	//	fmt.Println("youa re lisi")
//	//	fallthrough
//	//default:
//	//	fmt.Println("nonody.")
//	//}
...
//	//fmt.Printf("%d + %d = %d\n", x, y, xPLUSy)
//	//fmt.Printf("%d * %d = %d\n", x, y, xTIMESy)
//	fmt.Println(myFunc2(1, 2, 3, 4, 5, 6, 7, 8, 9))
//}
